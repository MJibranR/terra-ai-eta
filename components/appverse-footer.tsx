      ...
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <Card className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10">
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            {/* Left copy */}
            <div>
              <p className="mb-2 text-[11px] tracking-widest text-primary">STREAMLINE YOUR LAUNCHES</p>
                ...
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <div className="relative p-3">
                    ...
                    <div className="space-y-1 px-1">
                      <div className="text-5xl font-extrabold text-primary">Approvals Made Easy</div>
        ...
        <div className="container mx-auto px-4 py-10">
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xl font-semibold text-primary">Skitbit</span>
              </div>
          ...
          <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-xs text-neutral-500 sm:flex-row">
            ...
            <div className="flex items-center gap-6">
              <Link href="/revisions" className="hover:text-primary">
                Revision Policy
              </Link>
              <Link href="/t&c" className="hover:text-primary">
                Terms & Conditions
              </Link>
            </div>
          </div>
